...
/**
 * Strings for component 'tool_customlang', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['confirmcheckin'] = 'Você está prestes a salvar modificações no seu pacote de idioma local. Isto irá exportar os termos customizados do tradutor para seu diretório de dados do moodle (moodledata) e, a partir daí, o moodle passará a usar os termos modificados. Clique em \'Continuar" para salvar.';
$string['customlang:edit'] = 'Editar tradução local';
$string['customlang:view'] = 'Ver tradução local';
$string['filter'] = 'Filtrar strings';
$string['filtercomponent'] = 'Mostrar strings desses componetes';
$string['filtercustomized'] = 'Somente personalizadas';
$string['filtermodified'] = 'Somente modificadas';
...
$string['markinguptodate'] = 'Marcar customizações como atualizadas';
$string['markinguptodate_help'] = 'Traduções customizadas pode ficar desatualizadas se a string no original em inglês ou a tradução do idioma forem modificadas depois  que a string for customizada no seu site. Revise a customização da tradução e, se a tradução estiver atualizada, clique no checkbox. Caso contrário edite a string.';
