...
/**
 * Strings for component 'choice', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   choice
...
$string['eventanswercreated'] = 'Escolha feita';
...
$string['skipresultgraph'] = 'Saltar o gráfico de resultados';
