...
/**
 * Strings for component 'qtype_gapfill', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['pluginnameadding'] = 'Adicionando uma questão de preenchimento de lacunas.';
...
$string['wronganswers_help'] = 'Lista de palavras incorretas com o objetivo de confundir sobre qual é a resposta correta. Cada palavra é separada por vírgulas, apenas aplica-se em modo arrastar/caixa de seleção (dragdrop/dropdowns)';
