...
/**
 * Strings for component 'qtype_calculated', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['hexanotallowed'] = 'Conjunto de dados <strong>{$a->name}</strong> no formato format do valor {$a->value} não é permitido.';
...
$string['lengthoption'] = 'Selecione a opção de comprimento';
...
$string['pluginnameadding'] = 'Adicionar uma questão calculada';
$string['pluginnameediting'] = 'Editando uma pergunta calculada';
$string['pluginname_help'] = 'Questões calculadas permitem questões numéricas individuais a serem criadas usando curingas em chaves que são substituídos com valores individuais quando o questionário é preenchido. Por exemplo, a questão "Qual é a área de um retângulo de comprimento {l} e largura {w}?" teria fórmula resposta correta "{l}*{W}" (onde * denota a multiplicação).';
