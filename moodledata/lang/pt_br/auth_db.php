...
/**
 * Strings for component 'auth_db', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbhost'] = 'Computador que hospeda o servidor da base de dados. Use uma entrada DSN do sistema se estiver usando ODBC.';
...
$string['auth_dbname'] = 'Nome da base de dados em si. Deixe em branco se estiver usando um DSN ODBC.';
...
$string['auth_dbsyncuserstask'] = 'Sincronizar tarefa dos usuários';
