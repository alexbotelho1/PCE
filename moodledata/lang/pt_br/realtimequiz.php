...
/**
 * Strings for component 'realtimequiz', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['awaittimedesc'] = 'Esta configuração define a frequência em segundos para verificar os dados da pergunta e do resultado pela janela do browser do aluno. Quando o número elevado de participantes do quiz provoca a lentidão do servidor, este número deve ser aumentado para reduzir o número de chamadas simultâneas de dados. O valor mínimo é 1 segundo.';
...
$string['joinquizasstudent'] = 'Juntar-se ao teste como aluno';
