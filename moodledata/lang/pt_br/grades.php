...
/**
 * Strings for component 'grades', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   grades
...
$string['showcontributiontocoursetotal_help'] = 'Mostrar uma coluna adicional contendo a contribuição calculada para o total do curso?';
