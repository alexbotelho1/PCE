...
/**
 * Strings for component 'assignfeedback_editpdf', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['editpdf_help'] = 'Anotações de estudantes são feitas direto no navegador (browser) e resulta em um documento PDF editado para download.';
$string['enabled'] = 'Anotar PDF';
$string['enabled_help'] = 'Se habilitado, o professor poderá criar anotações em arquivos PDF quando estiver fazendo a correção. O professor terá permissão para adicionar comentários, adicionando diretamente desenhos e selos em cima do trabalho do aluno. As anotações são feitas no navegador (browser) e não é necessário o uso de qualquer outro software.';
...
$string['output'] = 'Saída:';
$string['oval'] = 'Oval';
$string['pagenumber'] = 'Párgina {$a}';
$string['pagexofy'] = 'Página {$a->page} de {$a->total}';
$string['pathtogspathdesc'] = 'Por favor, note que anotar PDF requer o caminho para Ghostscript esteja definido em {$a}.';
$string['pen'] = 'Caneta';
...
$string['test_doesnotexist'] = 'O caminho Ghostscript aponta para um arquivo inexistente';
$string['test_empty'] = 'O caminho ghostscript está vazio - digite o caminho correto';
$string['testgs'] = 'Testar caminho ghostscript';
$string['test_isdir'] = 'O caminho Ghostscript aponta para uma pasta, por favor inclua o programa ghostscript no caminho especificado';
...
$string['test_ok'] = 'O caminho ghostscript parece estar correto - por favor verifique se você pode ver a mensagem na imagem abaixo';
