...
/**
 * Strings for component 'forum', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   forum
...
$string['cannotfindorcreateforum'] = 'Não foi possível encontrar ou criar um fórum principal de noticias neste site.';
...
$string['cannotmovetosingleforum'] = 'Não foi possível mover a discussão para um fórum de uma única discussão';
...
$string['cannotunsubscribe'] = 'Não é possível retirar a sua subscrição a este fórum.';
...
$string['configtrackingtype'] = 'Configuração padrão para o rastreamento de leitura.';
...
$string['digestmailheader'] = 'Este é o compêndio diário das novas mensagens dos fóruns de {$a->sitename}. Você pode mudar as suas preferências em relação às cópias das mensagens do fórum recebidas via e-mail na seguinte página do site {$a->userprefs}.';
$string['digestmailpost'] = 'Alterar suas opções de resumo';
$string['digestmailpostlink'] = 'Alterar suas configurações de compilação dos fóruns: {$a}';
$string['digestmailprefs'] = 'O seu perfil';
$string['digestmailsubject'] = '{$a}: Resumo das mensagens do fórum';
$string['digestmailtime'] = 'Horário de envio do resumo de emails';
$string['digestsentusers'] = 'Digests enviados a {$a} usuários.';
$string['disallowsubscribe'] = 'Não são autorizadas subscrições';
...
$string['discussionsubscription_help'] = 'Inscrever-se em uma discussão significa que você vai receber notificações de novos posts para essa discussão.';
...
$string['emaildigest_0'] = 'Você irá receber um email por mensagem no fórum.';
$string['emaildigest_1'] = 'Você irá receber um resumo por email por dia contendo o conteúdo completo de cada mensagem do fórum.';
$string['emaildigest_2'] = 'Você irá receber um resumo por email por dia contendo o assunto de cada mensagem do fórum.';
...
* Padrão - acompanhar a definição digest encontrado em seu perfil de usuário. Se você atualizar o seu perfil, em seguida, que a mudança será refletida aqui também;
...
* Digest - apenas temas - você receberá um resumo de e-mail por dia contendo apenas o assunto de cada post no fórum.';
$string['emaildigestupdated'] = 'A opção de alerta por eamil foi alterada para \'{$a->maildigesttitle}\' para o fórum \'{$a->forum}\'. {$a->maildigestdescription}';
$string['emaildigestupdated_default'] = 'Sua configuração padrão \'{$a->maildigesttitle}\' foi usada para o fórum \'{$a->forum}\'. {$a->maildigestdescription}.';
...
$string['forum:canoverridediscussionlock'] = 'Responder a discussõpes bloqueadas';
...
$string['invaliddigestsetting'] = 'Uma configuração de alerta de email inválida foi fornacida';
...
$string['lockdiscussionafter'] = 'Bloquear discussções após período de inatividade';
...
$string['messageprovider:digests'] = 'Compêndios subscritos do fórum';
...
$string['nopermissiontosubscribe'] = 'Você não tem permissão para ver fórum de subscritores';
...
$string['postbymailsuccess'] = 'Parabéns, o seu post no fórum com o assunto "{$a->subject}" foi adicionado com sucesso. Você pode vê-lo em {$a->discussionurl}.';
