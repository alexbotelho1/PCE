...
/**
 * Strings for component 'block_use_stats', language 'pt_br', branch 'MOODLE_32_STABLE'
 *
...
$string['studentchoice'] = 'Alunos escolhem';
$string['studentscansee'] = 'Alunos podem ver';
