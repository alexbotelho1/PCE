...
/**
 * Strings for component 'game', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   game
...
$string['hiddenpicture_pictureglossary'] = 'O glossário para a questão principal';
...
$string['millionaire_must_select_questioncategory'] = 'Uma categoria de questões deve ser selecionada';
$string['millionaire_must_select_quiz'] = 'Um questionário deve ser selecionado';
$string['millionaire_options'] = 'Opções do Milionário';
