...
/**
 * Strings for component 'availability_grade', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['requires_max'] = 'Você recebe uma pontuação apropriada em <strong>{$a}</strong>';
$string['requires_min'] = 'Você obtém a pontuação necessária em <strong>{$a}</strong>';
...
$string['requires_range'] = 'Você recebe uma pontuação específica em <strong>{$a}</strong>';
$string['title'] = 'Nota';
