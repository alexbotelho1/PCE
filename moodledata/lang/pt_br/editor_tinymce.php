...
/**
 * Strings for component 'editor_tinymce', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['advanced:block'] = 'Formatar';
$string['advanced:blockquote'] = 'Bloco de citação';
$string['advanced:blockquote_desc'] = 'Bloco de citação';
$string['advanced:bold_desc'] = 'Negrito (Ctrl + B)';
$string['advanced:bullist_desc'] = 'Inserir/remover lista com bullets';
...
$string['advanced:cleanup_desc'] = 'Limpar código desarrumado';
$string['advanced:clipboard_msg'] = 'Copiar/cortar/colar não está disponível no Mozilla e Firefox. Você deseja obter mais informações sobre este caso?';
...
$string['advanced:custom1_desc'] = 'Sua descrição personalizada aqui';
...
$string['advanced_dlg:about_loaded'] = 'Plugins carregados';
...
$string['advanced_dlg:accessibility_help'] = 'Ajuda sobre acessibilidade';
$string['advanced_dlg:accessibility_usage_title'] = 'Uso geral';
$string['advanced_dlg:anchor_invalid'] = 'Por favor, especifique um nome válido para a âncora';
$string['advanced_dlg:anchor_name'] = 'Nome da âncora';
$string['advanced_dlg:anchor_title'] = 'Inserir/editar âncora';
$string['advanced_dlg:charmap_title'] = 'Selecionar caractere especial';
$string['advanced_dlg:charmap_usage'] = 'Use as setas da direita e esquerda para navegar';
...
$string['advanced_dlg:colorpicker_named_tab'] = 'Nomeado';
$string['advanced_dlg:colorpicker_named_title'] = 'Cores nomeadas';
$string['advanced_dlg:colorpicker_palette_tab'] = 'Paleta';
$string['advanced_dlg:colorpicker_palette_title'] = 'Cores da paleta';
$string['advanced_dlg:colorpicker_picker_tab'] = 'Seletor';
$string['advanced_dlg:colorpicker_picker_title'] = 'Seletor de cores';
$string['advanced_dlg:colorpicker_title'] = 'Selecione uma cor';
$string['advanced_dlg:image_align'] = 'Alinhamento';
$string['advanced_dlg:image_align_baseline'] = 'Linha de base';
...
$string['advanced_dlg:image_align_textbottom'] = 'Parte inferior do texto';
...
$string['advanced_dlg:image_border'] = 'Borda';
...
$string['advanced_dlg:image_src'] = 'URL da imagem';
...
$string['advanced_dlg:link_is_email'] = 'A URL digitada parece ser um endereço de e-mail. Deseja acrescentar o prefixo "mailto:" para link de e-mail?';
$string['advanced_dlg:link_is_external'] = 'A URL digitada parece ser a um link externo. Deseja acrescentar o prefixo http://?';
$string['advanced_dlg:link_list'] = 'Lista de links';
$string['advanced_dlg:link_target'] = 'Alvo';
$string['advanced_dlg:link_target_blank'] = 'Abrir link em uma nova janela';
$string['advanced_dlg:link_target_same'] = 'Abrir link na mesma janela';
$string['advanced_dlg:link_title'] = 'Inserir/editar link';
$string['advanced_dlg:link_titlefield'] = 'Título';
$string['advanced_dlg:link_url'] = 'URL do link';
$string['advanced:dt'] = 'Definição do termo';
$string['advanced:fontdefault'] = 'Família da fonte';
$string['advanced:font_size'] = 'Tamanho da fonte';
$string['advanced:forecolor_desc'] = 'Selecione a cor do texto';
...
$string['advanced:help_shortcut'] = 'ressione ALT-F10 para barra de ferramentas. Pressione ALT-0 para ajuda';
...
$string['advanced:indent_desc'] = 'Aumentar identação';
$string['advanced:italic_desc'] = 'Itálico (Ctrl+I)';
$string['advanced:justifycenter_desc'] = 'Centralizar';
...
$string['advanced:link_desc'] = 'Inserir/editar link';
...
$string['advanced:outdent_desc'] = 'Diminuir identação';
...
$string['advanced:rich_text_area'] = 'Área de texto rico';
$string['advanced:samp'] = 'Amostra de código';
$string['advanced:shortcuts_desc'] = 'Ajuda de acessibilidade';
$string['advanced:striketrough_desc'] = 'Riscado';
$string['advanced:style_select'] = 'Estilos';
$string['advanced:sub_desc'] = 'Subscrito';
$string['advanced:sup_desc'] = 'Sobrescrito';
$string['advanced:toolbar'] = 'Barra de ferramentas';
$string['advanced:toolbar_focus'] = 'Ir para as ferramentas - Alt+Q, ir para o editor - Alt-Z, ir para o caminho do elemento - Alt-X';
$string['advanced:underline_desc'] = 'Sublinhado (Ctrl+U)';
$string['advanced:undo_desc'] = 'Desfazer (Ctrl+Z)';
$string['advanced:unlink_desc'] = 'Remover link';
...
$string['advimage_dlg:border'] = 'Borda';
...
$string['advimage_dlg:long_desc'] = 'Link da descrição extensa';
$string['advimage_dlg:ltr'] = 'Da esquerda para a direita';
$string['advimage_dlg:map'] = 'Mapa de imagem';
$string['advimage_dlg:misc'] = 'Miscelânea';
$string['advimage_dlg:missing_alt'] = 'Tem certeza que deseja continuar sem acrescentar uma descrição à imagem? Sem ela a imagem pode não ser acessível a alguns usuários com deficiências, ou aqueles utilizando navegadores modo texto, ou navegando na web com imagens desligadas.';
...
$string['advimage_dlg:src'] = 'URL da imagem';
...
$string['advlink_dlg:is_external'] = 'A URL digitada parece ser a um link externo. Deseja acrescentar o prefixo http://?';
$string['advlink_dlg:langcode'] = 'Código do idioma';
$string['advlink_dlg:langdir'] = 'Direção do texto';
$string['advlink_dlg:link_list'] = 'Lista de links';
$string['advlink_dlg:list'] = 'Lista de links';
...
$string['advlink_dlg:target_parent'] = 'Abrir na janela/frame anterior';
$string['advlink_dlg:target_same'] = 'Abrir nesta janela/frame';
$string['advlink_dlg:target_top'] = 'Abrir no frame topo (substitui todos os frames)';
$string['advlink_dlg:title'] = 'Inserir/editar link';
$string['advlink_dlg:titlefield'] = 'Título';
$string['advlink_dlg:url'] = 'URL do link';
$string['advlink_dlg:width'] = 'Largura';
$string['advlink:link_desc'] = 'Inserir/editar link';
$string['advlist:circle'] = 'Círculo';
$string['advlist:def'] = 'Padrão';
$string['advlist:disc'] = 'Disco';
$string['advlist:lower_alpha'] = 'Alfabeto minúsculo';
$string['advlist:lower_greek'] = 'Alfabeto grego';
$string['advlist:lower_roman'] = 'Num. romanos minúsculos';
$string['advlist:square'] = 'Quadrado';
$string['advlist:types'] = 'Tipos';
$string['advlist:upper_alpha'] = 'Alfabeto maiúsculos';
$string['advlist:upper_roman'] = 'Num. romanos maiúsculos';
$string['aria:rich_text_area'] = 'Área de texto rico';
$string['autosave:restore_content'] = 'Restaura conteúdo salvo automaticamente';
$string['autosave:unload_msg'] = 'As mudanças efetuadas serão perdidas se sair desta página.';
$string['autosave:warning_message'] = 'Se restaurar o conteúdo, você irá perder tudo que está atualmente no editor.
...
$string['colors:003300'] = 'Verd';
$string['colors:003366'] = 'Azul escuro';
$string['colors:008000'] = 'Verde';
$string['colors:008080'] = 'Marrequinho';
$string['colors:00CCFF'] = 'Céu azul';
$string['colors:00FF00'] = 'Cal';
$string['colors:00FFFF'] = 'Água';
$string['colors:333300'] = 'Oliva escuro';
$string['colors:333333'] = 'Cinza muito escuro';
$string['colors:333399'] = 'Índigo';
$string['colors:3366FF'] = 'Azul real';
$string['colors:339966'] = 'Mar verde';
$string['colors:33CCCC'] = 'Turquesa';
$string['colors:666699'] = 'Azul acinzentado';
$string['colors:800000'] = 'Foquete';
$string['colors:800080'] = 'Roxo';
$string['colors:808000'] = 'Oliva';
$string['colors:808080'] = 'Cinza';
$string['colors:993300'] = 'Laranja queimado';
$string['colors:993366'] = 'Marrom';
$string['colors:999999'] = 'Cinza médio';
$string['colors:99CC00'] = 'Verde amarelo';
$string['colors:99CCFF'] = 'Luz do céu azul';
$string['colors:C0C0C0'] = 'Prata';
$string['colors:CC99FF'] = 'Ameixa';
$string['colors:CCFFCC'] = 'Verde pálido';
$string['colors:CCFFFF'] = 'Pálido ciano';
$string['colors:FF0000'] = 'Vermelho';
$string['colors:FF00FF'] = 'Magenta';
$string['colors:FF6600'] = 'Laranja';
$string['colors:FF9900'] = 'Âmbar';
$string['colors:FF99CC'] = 'Rosa';
$string['colors:FFCC00'] = 'Ouro';
$string['colors:FFCC99'] = 'Pêssego';
$string['colors:FFFF00'] = 'Amarelo';
$string['colors:FFFF99'] = 'Luz amarela';
$string['colors:FFFFFF'] = 'Branco';
$string['common:apply'] = 'Aplicar';
$string['common:browse'] = 'Navegar';
$string['common:cancel'] = 'Cancelar';
$string['common:class_name'] = 'Classe';
$string['common:clipboard_msg'] = 'Copiar/recortar/colar não está disponível no Mozilla e Firefox. Deseja mais informações sobre esta questão?';
$string['common:clipboard_no_support'] = 'O seu navegador não suporta esta função, use os atalhos do teclado.';
$string['common:close'] = 'Fechar';
$string['common:edit_confirm'] = 'Deseja usar o modo WYSIWYG neste campo de texto?';
$string['common:insert'] = 'Inserir';
$string['common:invalid_data'] = 'Erro: Valores inválidos informados, marcados em vermelho.';
$string['common:invalid_data_min'] = '{#field} deve ser um número maior do que {#min}';
$string['common:invalid_data_number'] = '{#field} deve ser um número';
$string['common:invalid_data_size'] = '{#field} deve ser um número ou percentagem';
$string['common:more_colors'] = 'Mais Cores...';
$string['common:not_set'] = '-- N/A --';
$string['common:popup_blocked'] = 'Detectamos que o seu bloqueador de popups bloqueou uma janela que é essencial para a aplicação. Você precisa desativar o bloqueador de popups para este site para utilizar esta ferramenta.';
...
$string['customconfig_desc'] = 'Personalizado de configuração avançada TinyMCE no formato JSON, por exemplo: {&quot;opção1&quot;: &quot;valor2&quot;, &quot;opção2&quot;: &quot;valor2&quot;}. Quaisquer opções especificadas aqui substituem as configurações padrão e plugin.';
$string['customtoolbar'] = 'Barra de ferramentas do editor';
$string['customtoolbar_desc'] = 'Cada linha contém uma lista de nomes separados por vírgula tecla, use "wrap" como um separador de grupo, as linhas em branco são ignoradas. Consulte <a href="{$a}" target="_blank">{$a}</a> para a lista de botões TinyMCE padrão. <br /> A primeira linha será sempre mostrado, onde como a visibilidade da segundo e terceiro barras de ferramentas pode ser alternado.';
...
$string['emotions_dlg:cool'] = 'Legal';
...
$string['emotions_dlg:usage'] = 'Use as setas esquerda e direita para navegar.';
$string['emotions_dlg:wink'] = 'Piscadela';
$string['emotions_dlg:yell'] = 'Irado';
$string['emotions:emotions_desc'] = 'Emoticons';
$string['fontselectlist'] = 'Lista de fontes disponíveis';
...
$string['fullpage_dlg:add_script'] = 'Elementro script';
...
$string['fullpage_dlg:appearance_marginprops'] = 'Margens do corpo (body)';
...
$string['fullpage_dlg:bottom_margin'] = 'Margem da base';
...
$string['fullpage_dlg:fontface'] = 'Família da fonte';
$string['fullpage_dlg:font_face'] = 'Font face';
$string['fullpage_dlg:fontsize'] = 'Tamanho da fonte';
$string['fullpage_dlg:font_size'] = 'Tamanho da fonte';
...
$string['fullpage_dlg:link_color'] = 'Cor do link';
$string['fullpage_dlg:link_element'] = 'Elemento link';
$string['fullpage_dlg:ltr'] = 'Esquerda para direita';
$string['fullpage_dlg:media'] = 'Mídia';
$string['fullpage_dlg:meta_description'] = 'Descrição';
$string['fullpage_dlg:meta_element'] = 'Elemento meta';
$string['fullpage_dlg:meta_index_follow'] = 'Indexar e seguir os links';
$string['fullpage_dlg:meta_index_nofollow'] = 'Indexar e não seguir os links';
$string['fullpage_dlg:meta_keywords'] = 'Palavras-chave';
$string['fullpage_dlg:meta_noindex_follow'] = 'Não indexar, mas seguir os links';
$string['fullpage_dlg:meta_noindex_nofollow'] = 'Não indexar e não seguir os links';
$string['fullpage_dlg:meta_props'] = 'Meta-informação';
$string['fullpage_dlg:meta_robots'] = 'Robôs';
...
$string['fullpage_dlg:visited_color'] = 'Cor de link visitado';
$string['fullpage_dlg:xml_pi'] = 'Declaração XML';
$string['fullscreen:desc'] = 'Alternar modo de tela cheia';
$string['iespell:download'] = 'ieSpell não detectado. Deseja instalar agora?';
...
$string['media_dlg:audio'] = 'HTML5 áudio';
...
$string['media_dlg:captioningid'] = 'Caption ID';
...
$string['media_dlg:correction'] = 'Sem correção';
...
$string['media_dlg:embedded_audio_options'] = 'Opões de áudio incorporado';
...
$string['media_dlg:fullscreen'] = 'Tela cheia';
...
$string['media_dlg:imagestatus'] = 'Estado da imagem';
...
$string['media_dlg:playeveryframe'] = 'Tocar todos os frames';
$string['media_dlg:poster'] = 'Poster';
$string['media_dlg:prefetch'] = 'Prefetch';
$string['media_dlg:preload'] = 'Preload';
$string['media_dlg:preload_auto'] = 'Deixar navegador do usuário decidir';
$string['media_dlg:preload_metadata'] = 'Pré-carregar metadados de vídeo';
...
$string['media_dlg:shuffle'] = 'Embaralhar';
...
$string['media_dlg:video'] = 'HTML5 vídeo';
...
$string['media:edit'] = 'Editar mídia embedded';
...
$string['paste:paste_text_desc'] = 'Colar como texto plano';
$string['paste:paste_word_desc'] = 'Colar (copiado do WORD)';
$string['paste:plaintext_mode'] = 'Comando colar está em modo texto plano. Clique novamente para voltar para o modo normal.';
$string['paste:plaintext_mode_stick'] = 'Colagem agora está em modo de texto simples. Clique novamente para alternar para o modo colar regular.';
...
$string['simple:bullist_desc'] = 'Inserir/remover lista não-ordenada';
$string['simple:cleanup_desc'] = 'Limpar código incorreto';
$string['simple:italic_desc'] = 'Itálico (Ctrl+I)';
$string['simple:numlist_desc'] = 'Inserir/remover lista ordenada';
...
$string['spellchecker:desc'] = 'Ligar/desligar verificação ortográfica';
...
$string['spellchecker:learn_word'] = 'Aprenda palavra';
...
$string['style_dlg:block'] = 'Bloquear';
$string['style_dlg:block_display'] = 'Exibir';
...
$string['style_dlg:title'] = 'Editor de estilos CSS';
$string['style_dlg:toggle_insert_span'] = 'Insir spam na seleção';
...
$string['table:cut_row_desc'] = 'Recortar linha';
$string['table:del'] = 'Excluir Tabela';
$string['table:delete_col_desc'] = 'Excluir coluna';
$string['table:delete_row_desc'] = 'Excluir linha';
...
$string['table_dlg:border'] = 'Borda';
$string['table_dlg:bordercolor'] = 'Cor da borda';
...
$string['table_dlg:cell_limit'] = 'Você excedeu o número máximo de {$cells} células.';
...
$string['table_dlg:col_limit'] = 'Excedeu o número máximo de {$cols} colunas.';
...
$string['table_dlg:missing_scope'] = 'Tem certeza que quer continuar sem especificar um escopo para esta célula de cabeçalho da tabela?
Sem isso, pode ser difícil para alguns usuários com deficiências entender o conteúdo ou dados mostrados na tabela.';
$string['table_dlg:row_all'] = 'Atualizar todas as linhas';
$string['table_dlg:row_even'] = 'Atualizar linhas pares';
$string['table_dlg:rowgroup'] = 'Grupo de linhas';
$string['table_dlg:row_limit'] = 'Excedeu o número máximo de  {$rows} linhas.';
...
$string['table_dlg:rules_border'] = 'borda';
...
$string['table_dlg:th'] = 'Cabeçalho';
$string['table_dlg:thead'] = 'Cabeçalho';
$string['table_dlg:title'] = 'Inserir/editar tabela';
...
$string['visualblocks:desc'] = 'Mostrar / ocultar elementos de bloco';
$string['visualchars:desc'] = 'Mostrar/ocultar caracteres de controle visuais';
...
$string['xhtmlxtras:del_desc'] = 'Exclusão';
...
$string['xhtmlxtras_dlg:insert_date'] = 'Inserir data/hora atuais';
...
$string['xhtmlxtras_dlg:title_abbr_element'] = 'Elemento abreviação';
$string['xhtmlxtras_dlg:title_acronym_element'] = 'Elemento acrônimo';
$string['xhtmlxtras_dlg:title_cite_element'] = 'Elemento citação';
$string['xhtmlxtras_dlg:title_del_element'] = 'Elemento exclusão';
$string['xhtmlxtras_dlg:title_ins_element'] = 'Elemento inserção';
$string['xhtmlxtras:ins_delta_height'] = '';
$string['xhtmlxtras:ins_delta_width'] = '';
$string['xhtmlxtras:ins_desc'] = 'Inserção';
