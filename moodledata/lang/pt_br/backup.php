...
/**
 * Strings for component 'backup', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   backup
...
$string['automateddeletedays'] = 'Apagar backups mas antigos que';
$string['automatedmaxkept'] = 'Número máximo de backups guardados';
...
$string['automatedminkept'] = 'Número mínimo de backups guardados';
...
$string['filereferencesincluded'] = 'Referências em arquivos a conteúdos externos incluídos no pacote de backup não funcionarão em outros sites.';
$string['filereferencesnotsamesite'] = 'Backup de outro site, referências não puderam ser restauradas';
$string['filereferencessamesite'] = 'Backup do mesmo site, referências podem ser restauradas';
...
$string['missingfilesinpool'] = 'Alguns arquivos não puderam ser salvos durante o backup, será impossível restaurá-los.';
