...
/**
 * Strings for component 'media_videojs', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['configaudioextensions'] = 'Uma lista de extensões de arquivos de áudio suportadas, separada por vírgulas. O VideoJS tentará usar o leitor de vídeo nativo do navegador quando estiver disponível, e retornará a um Leitor Flash para outros formatos se o Flash for suportado pelo navegador e o Flash fallback estiver ativado abaixo.';
...
$string['configuseflash'] = 'Utilizar o leitor de Flash se o formato de vídeo não for suportado nativamente pelo navegador. Se ativar esta opção, o VideoJS será mobilizado para qualquer extensão de arquivo da lista acima sem verificação do navegador. Tenha em atenção que o Flash não está disponível nos navegadores de smartfones e tablets e é desaconselhado em muitos computadores.';
