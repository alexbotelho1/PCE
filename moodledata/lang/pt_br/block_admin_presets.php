...
/**
 * Strings for component 'block_admin_presets', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['actionbase'] = 'Predefinições';
$string['actiondelete'] = 'Excluir predefinições';
...
$string['author'] = 'Autor';
$string['autohidesensiblesettings'] = 'Excluir automaticamente configurações sensíveis';
$string['created'] = 'Criado';
$string['deleteexecute'] = 'Execução';
$string['deletepreset'] = 'Predefinido {$a} será excluído, você tem certeza?';
$string['deletepreviouslyapplied'] = 'Esta predefinição foi aplicada anteriormente, se você apagá-la não poderá retornar ao estado anterior';
$string['deleteshow'] = 'Confirmar';
$string['errordeleting'] = 'Erro ao excluir do DB';
$string['errorinserting'] = 'Erro ao excluir do DB';
$string['errornopreset'] = 'Não existe uma predefinição com esse nome';
$string['eventpresetdeleted'] = 'Predefinido excluído';
$string['eventpresetdownloaded'] = 'Predefinido baixado';
$string['eventpresetexported'] = 'Predefinido exportado';
$string['eventpresetimported'] = 'Predefinido importado';
$string['eventpresetloaded'] = 'Predefinido carregado';
$string['eventpresetpreviewed'] = 'Predefinido visualizado';
$string['eventpresetreverted'] = 'Predefinido revertido';
$string['eventpresetslisted'] = 'Predefinidos foram listados';
$string['exportshow'] = 'Selecione Configurações';
...
$string['loadpreview'] = 'Visualizar predefinições';
