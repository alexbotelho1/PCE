...
/**
 * Strings for component 'mnet', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   mnet
...
$string['hostexists'] = 'Um registro já existe para um host com esse hostname (pode ser excluído). <a href="{$a}"> Clique aqui</a> para modificar esse registro.';
