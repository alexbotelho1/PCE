...
/**
 * Strings for component 'block_enrolmenttimer', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['activecountdown_help'] = 'Contagem decrescente ativa do tempo restante que o aluno tem para acessar à disciplina usando javascript';
$string['completionpercentage'] = 'Percentagem para notificação';
$string['completionpercentage_help'] = 'Percentagem que o aluno deve obter no \'Total da disciplina\' para receber o e-mail da conclusão';
...
$string['completionsmessage_help'] = 'Mensagem do e-mail que será enviado ao aluno congratulando-o da conclusão da disciplina. Pode usar as seguintes personalizações: [[user_name]] [[course_name]]';
...
$string['displayNothingNoDateSet_help'] = 'Ocultar o bloco aos usuários que não têm data final definida. Se desativada, será mostrada uma mensagem aos alunos';
...
$string['timeleftmessage_help'] = 'Mensagem do e-mail que será enviado ao aluno notificando-o do tempo restante da inscrição na disciplina, por exemplo, 10 dias restantes. Pode usar as seguintes personalizações: [[user_name]] [[course_name]] [[days_to_alert]]';
