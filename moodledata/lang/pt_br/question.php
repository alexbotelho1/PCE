...
/**
 * Strings for component 'question', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   question
...
$string['categorymove'] = 'A categoria \'{$a->name}\' contém {$a->count} questões (algumas das quais podem ser perguntas ocultas ou perguntas aleatórias que ainda estão em uso em um quiz). Escolha outra categoria para movê-la para.';
...
$string['rightanswer_help'] = 'Um sumário gerado automaticamente com as respostas corretas. Este pode ser limitado, portanto você pode pensar em explicar a solução correta no feedback geral para a questão desligando essa opção.';
$string['save'] = 'Salvar';
