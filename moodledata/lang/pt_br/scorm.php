...
/**
 * Strings for component 'scorm', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   scorm
...
<p>O estudante pode escolher prever a atividade (modo de navegação), ou tentar respondê-la, no modo normal.</p>
...
$string['tracklatency_help'] = 'Tempo decorrido entre o momento da interação <br /> foi posto à disposição do estudante para a resposta <br /> eo tempo da primeira resposta';
$string['trackpattern'] = 'Padrão';
$string['trackpattern_help'] = 'Isto é o que uma resposta correta a esta pergunta seria, ele não mostra a resposta estudantes.';
$string['trackresponse'] = 'Resposta';
$string['trackresponse_help'] = 'Esta é a resposta dada pelo estudante para esta pergunta';
$string['trackresult'] = 'Resultado';
$string['trackresult_help'] = 'Resultado baseado na resposta do estudante e resultado correto';
...
$string['trackscoreraw_help'] = 'Número que reflete o desempenho do estudante <br /> em relação ao intervalo delimitada pelos valores de min e max';
$string['tracksuspenddata'] = 'Suspender dados';
$string['tracksuspenddata_help'] = 'Fornece espaço para armazenar e recuperar dados <br /> entre as sessões de estudante';
