...
/**
 * Strings for component 'choicegroup', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   choicegroup
...
Você pode preencher qualquer número destes. Se você deixar algumas das opções em branco, eles não serão exibidos. Se você precisar de mais opções, clique no botão "Adicionar 3 campos para formar".';
...
$string['option'] = 'Grupo';
$string['pleasesetgroups'] = 'Por favor, crie pelo menos dois grupos neste curso.';
$string['pluginname'] = 'Escolha o grupo';
$string['privacy'] = 'Resultados Privados';
$string['publish'] = 'Resultados Públicos';
$string['publishafteranswer'] = 'Mostrar resultados para os alunos após eles responderem';
$string['publishafterclose'] = 'Mostrar resultados para os alunos somente após a escolha estar fechada';
$string['publishalways'] = 'Sempre mostrar resultados para os alunos';
$string['publishanonymous'] = 'Publicar os resultados anônimos, não mostre os nomes dos alunos';
$string['publishnames'] = 'Publicar os resultados completos, mostrando os nomes e as suas escolhas';
$string['publishnot'] = 'Não publicar resultados para os alunos';
