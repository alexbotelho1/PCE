...
/**
 * Strings for component 'qtype_wordselect', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['correctanswer'] = 'resposta (dada) correta';
$string['correctresponse'] = 'resposta (possível) correta';
$string['delimitchars'] = 'Caracteres delimitadores';
$string['delimitchars_help'] = 'Altere os caracteres que delimitam um campo, do padrão [ ] , útil para questões de linguagens de programação.';
$string['incorrectresponse'] = 'resposta (possível) incorreta';
$string['introduction'] = 'Introdução';
$string['introduction_help'] = 'Introdução à questão, este texto não será selecionável';
$string['nowordsdefined'] = 'Nenhuma palavra para selecionar foi definida';
$string['pluginname'] = 'Escolha de palavra';
