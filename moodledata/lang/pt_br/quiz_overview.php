...
/**
 * Strings for component 'quiz_overview', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['overviewreportgraph'] = 'Número de estudantes por faixas de nota';
...
$string['regradecomplete'] = 'Reavaliação concluída com êxito';
...
$string['showdetailedmarks'] = 'Resultados de cada questão';
