...
/**
 * Strings for component 'bigbluebuttonbn', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['bigbluebuttonbn:addinstance'] = 'Adicionar uma nova reunião';
...
$string['config_extended_feature_uidelegation_enabled'] = 'A delegação de UI está ativada';
$string['config_feature_recording'] = 'Configuração para a função "Gravação"';
...
$string['event_activity_modified'] = 'Atividade BigBlueButtonBN modificada';
$string['event_activity_viewed'] = 'Atividade BigBlueButtonBN visualizada';
$string['event_activity_viewed_all'] = 'Gerenciamento de atividades BigBlueButtonBN visualizado';
...
$string['mod_form_block_schedule'] = 'Agendar para sessões';
...
$string['mod_form_field_wait'] = 'Os estudantes devem esperar até que um moderador entrar';
...
$string['view_recording_list_actionbar_deleting'] = 'Excluindo';
