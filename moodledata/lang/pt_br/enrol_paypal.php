...
/**
 * Strings for component 'enrol_paypal', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['pluginname_desc'] = 'O módulo Paypal permite configurar cursos pagos. Caso o custo para qualquer curso seja zero, então os estudantes não serão questionados pelo pagamento para acessar. Existirá um curso em todo o site, configurado como padrão e um custo par acurso que será configurado para cada curso individualmente. O custo do curso sobrepõe-se ao custo do site.';
