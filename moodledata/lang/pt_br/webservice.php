...
/**
 * Strings for component 'webservice', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   webservice
...
$string['eventwebservicefunctioncalled'] = 'Função do Web service chamada';
$string['eventwebserviceloginfailed'] = 'Login do web service falhou';
$string['eventwebserviceservicecreated'] = 'Web service criado';
$string['eventwebserviceservicedeleted'] = 'Serviço de "Web service" excluído';
$string['eventwebserviceserviceupdated'] = 'Web service atualizado';
$string['eventwebserviceserviceuseradded'] = 'Web service adicionado a usuário';
$string['eventwebserviceserviceuserremoved'] = 'Usuário de serviço de "Web service" removido';
