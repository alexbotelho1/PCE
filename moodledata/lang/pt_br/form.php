...
/**
 * Strings for component 'form', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   form
...
$string['addfields'] = 'Acrescentar {$a} campos ao formulário';
...
$string['err_maxfiles'] = 'Você não pode anexar mais do que {$a} arquivos aqui.';
$string['err_maxlength'] = 'Você deve inserir mais do que {$a->format} caracteres aqui.';
...
$string['err_numeric'] = 'Inserir um número.';
$string['err_rangelength'] = 'Inserir de {$a->format[0]} a {$a->format[1]} characteres.';
$string['err_required'] = 'Inserir um valor.';
$string['general'] = 'Geral';
$string['hideadvanced'] = 'Ocultar avançado';
$string['hour'] = 'Hora';
$string['minute'] = 'Minuto';
$string['miscellaneoussettings'] = 'Outras Configurações';
$string['modstandardels'] = 'Configurações comuns de módulos';
$string['month'] = 'Mês';
$string['mustbeoverriden'] = 'O método abstrato form_definition() na classe {$a} deve ser sobrescrito, por favor conserte o código.';
$string['newvaluefor'] = 'Novo valor para {$a}';
$string['nomethodforaddinghelpbutton'] = 'Não existe um método para acrescentar um botão de ajuda ao elemento de formulário {$a->name} (class {$a->classname})';
$string['nonexistentformelements'] = 'Tentando acrescentar botões de ajuda em elementos de formulário inexistentes: {$a}';
$string['noselection'] = 'Sem seleção';
$string['nosuggestions'] = 'Sem sugestões';
$string['novalue'] = 'Nada inserido';
$string['novalueclicktoset'] = 'Clique para inserir texto';
...
$string['passwordunmaskrevealhint'] = 'Mostrar';
...
$string['somefieldsrequired'] = 'Este formulário contém campos obrigatórios marcados com {$a}.';
$string['time'] = 'Tempo';
