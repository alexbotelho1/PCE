...
/**
 * Strings for component 'attendance', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   attendance
...
Relatórios estão disponíveis para toda a turma ou individualmente para cada aluno.';
