...
/**
 * Strings for component 'quiz', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   quiz
...
$string['confirmremovesectionheading'] = 'Você tem certeza de que deseja remover a cabeçalho da seção \'{$a}\'?';
...
$string['editingquiz_help'] = 'Ao criar um questionário, os principais conceitos são:

* O questionário, contendo questões sobre uma ou mais páginas
* O banco de questões que armazena cópias de todas as questões organizadas em categorias
* Questões aleatórias - Um estudante recebe questões diferentes cada vez que inicia uma nova tentativa e diferentes estudantes podem obter diferentes questões';
...
$string['overduehandling_help'] = 'Esta configuração controla o que acontece se o estudante não envia sua tentativa questionário antes do tempo expirar. Se o estudante está trabalhando ativamente no questionário, no momento, então a contagem regressiva irá sempre enviar automaticamente a tentativa para eles, mas se eles deslogare, então essa configuração controla o que acontece.';
...
$string['questiondependencyadd'] = 'Não há restrição sobre quando a questão {$a->thisq} pode ser tentada • Clique para alterar';
$string['questiondependencyfree'] = 'Não há restrição sobre esta questão';
$string['questiondependencyremove'] = 'Questão {$a->thisq} não pode ser respondida até que a questão anterior {$a->previousq} tenha sido concluída • Clique para alterar';
$string['questiondependsonprevious'] = 'Esta questão não pode ser respondida até que a questão anterior tenha sido concluída.';
...
$string['quizopenclose_help'] = 'Estudantes podem iniciar tentativas apenas depois do horário de abertura e devem completar suas tentativas antes do horário de término.';
...
$string['redoquestion'] = 'Refazer questão';
...
$string['showuserpicture_help'] = 'Se ativado, o nome do estudante e a sua fotografia será mostrada na tela durante a tentativa, e na revisão, tornando mais fácil a verificação que o estudante está acessando como ele mesmo em um teste supervisionado.';
...
$string['theattempt_help'] = 'Define se o estudante pode ver o relatório da tentativa ou não.';
$string['time'] = 'Tempo';
...
$string['useroverridesdeleted'] = 'Sobreposições por usuário excluídas';
