...
/**
 * Strings for component 'portfolio', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   portfolio
...
$string['enableddesc'] = 'Se ativado, os usuários podem exportar conteúdo, como mensagens do fórum e Enviados, às carteiras externos ou páginas HTML.';
...
$string['intro'] = 'Conteúdo que você criou, tais como entrega de trabalhos, mensagens em fóruns e entradas de blog, pode ser exportado para um portfólio ou baixado. <br>
Qualquer portfólio que você não deseja utilizar pode ser escondido de modo que não fique listado como uma opção para exportar conteúdo para.';
...
$string['nocallbackcomponent'] = 'Não foi possível encontrar o componente especificado {$a}.';
$string['nocallbackfile'] = 'Alguma coisa no módulo que você está tentando exportar está quebrada - não foi possível encontrar o arquivo de portfólio';
