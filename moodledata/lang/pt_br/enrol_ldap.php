...
/**
 * Strings for component 'enrol_ldap', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   enrol_ldap
...
moodle/course:changeidnumber, moodle/course:changeshortname, moodle/course:changefullname e moodle/course:changesummary, dos papéis relevantes para previnir modificações dos quatro campos do curso especificados acima (ID number, nome curto, nome completo e sumário).</p>';
...
$string['role_mapping'] = '<p> Para cada papel que você deseja atribuir a partir do LDAP, você precisa especificar a lista de contextos onde os papéis dos grupos do curso estão localizados. Separe contextos diferentes,   com \';\'. </p><p> Você também precisa especificar o atributo que seu servidor LDAP utiliza para manter os membros de um grupo. Geralmente \'membro\' ou \'memberUid\' </p>';
...
$string['syncenrolmentstask'] = 'Sincronizar tarefa de inscrições';
