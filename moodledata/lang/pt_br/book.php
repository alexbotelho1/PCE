...
/**
 * Strings for component 'book', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   book
...
$string['removeallbooktags'] = 'Remova todos os marcadores do livro';
...
$string['tagtitle'] = 'Veja o marcador "{$a}"';
$string['toc'] = 'Sumário';
$string['top'] = 'topo';
