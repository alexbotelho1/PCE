...
/**
 * Strings for component 'moodle', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   moodle
...
$string['action'] = 'Ação';
$string['actionchoice'] = 'O que você deseja fazer com o arquivo \'{$a}\'?';
...
$string['addactivitytosection'] = 'Adicionar atividade ao tópico \'{$a}\'';
...
$string['addcreator'] = 'Adicionar criador de cursos';
...
$string['afterresource'] = 'Após recurso "{$a}"';
$string['aftersection'] = 'Após tópico "{$a}"';
...
$string['allowstealthmodules_help'] = 'Se ativado, a configuração de disponibilidade nas configurações comuns do módulo pode ter três opções, ao invés de duas - \'Mostrar na página do curso\', \'Ocultar dos estudantes\' e \'Deixar disponível mas não mostrar na página do curso\'. Se uma atividade ou recurso é configurado como disponível mas não visível na página do curso, um link para ele deve ser fornecido de outro lugar, como um recurso de página. A atividade ainda será listada no quadro de notas e outros relatórios.';
$string['allparticipants'] = 'Todos os participantes';
$string['allteachers'] = 'Todos os professores';
$string['alphanumerical'] = 'Deve conter apenas  caracteres alfanuméricos, hífen (-) ou ponto final (.)';
...
$string['categoriesandcoures'] = 'Categorias e Cursos';
...
$string['commentincontext'] = 'Encontre este comentário no contexto';
...
$string['courseduration_desc'] = 'A duração do curso é usada para calcular a data de término padrão do curso. A data de término do curso é usada somente para relatórios. Usuários ainda podem entrar no curso após a data de término.';
...
$string['defaultcompetencescaledesc'] = 'A escala de classificação binária que fornece nenhuma outra informação além se alguém tem demonstrado proficiência ou não.';
...
$string['editsection'] = 'Editar sessão';
...
$string['emaildigest'] = 'Tipo de compilação de email';
$string['emaildigestcomplete'] = 'Completo (um email diário com as mensagens completas dos fóruns)';
$string['emaildigest_help'] = 'Este é o cenário diário digest fóruns que vai usar por padrão.

* Sem digest - você receberá um e-mail por post no fórum;
* Digest - mensagens completas - você receberá um resumo de e-mail por dia contendo o conteúdo completo de cada post no fórum;
* Digest - apenas temas - você receberá um digerir e-mail por dia contendo apenas o assunto de cada post no fórum.
...
$string['emailpasswordconfirmmaybesent'] = '<p>Se o usuário e o email estiverem corretos um email deve ter sido enviado a você.</p>
<p>Este email contém fáceis instruções para confirmar e completar a alteração de senha.
...
$string['enddate_help'] = 'A data de término do curso é usada somente para relatórios. Os usuários ainda podem entrar no curso após a data de término.';
...
$string['filetoolarge'] = 'é muito grande para enviar';
...
$string['grade'] = 'Nota';
$string['grades'] = 'Notas';
$string['gravatarenabled'] = '<a href="http://www.gravatar.com/">Gravatar</a> foi habilitado para este site. Caso você não envie uma imagem para seu perfil o Moodle tentará carregar uma imagem de perfil para você a partir do Gravatar.';
$string['group'] = 'Grupo';
...
$string['hiddenoncoursepage'] = 'Disponível mas não mostrada na página do curso';
...
O Número ID também pode ser definido na página de edição do cálculo das notas no livro de notas, embora ele só possa ser editado na página de atualização da atividade.';
...
$string['managedataformats'] = 'Gerenciar os formatos de data';
...
$string['maxbytesforfile'] = 'O arquivo {$a} é maior do que o tamanho máximo permitido.';
...
$string['maxsizeandattachments'] = 'Tamanho máximo para novos arquivos: {$a->size}, máximo de anexos: {$a->attachments}';
$string['maxsizeandattachmentsandareasize'] = 'O tamanho máximo para novos arquivos, anexos: {$a->size} máximos: {$a->attachments}, limite global: {$a->areasize}';
$string['memberincourse'] = 'Participantes';
$string['messagebody'] = 'Texto da mensagem';
$string['messagedselectedcountusersfailed'] = 'Ocorreu um problema e {$a} mensagens não foram enviadas.';
$string['messagedselecteduserfailed'] = 'A mensagem não foi enviada para o usuário {$a->fullname}.';
...
$string['messageprovider:badgecreatornotice'] = 'Notificação de criador de badge';
$string['messageprovider:badgerecipientnotice'] = 'Notificação de destinatário de badge';
...
$string['modchooserdisable'] = 'Seletor de atividades desabilitado';
$string['modchooserenable'] = 'Seletor de atividades habilitado';
...
$string['modvisible_help'] = 'Se a disponibilidade estiver definida como "Mostrar na página do curso", a atividade ou recurso está disponível para estudantes (sujeito a restrições de acesso que podem ser definidas).<br><br>
...
$string['modvisiblehiddensection_help'] = 'Se a disponibilidade estiver definida como \'Ocultar dos estudantes\', a atividade ou recurso só estará disponível para usuários com permissão para visualizar atividades ocultas (por padrão, usuários com a função de professor ou professor não editor).<br><br>
Se o curso tiver muitas atividades ou recursos, a página do curso pode ser simplificada, definindo a disponibilidade para \'Disponibilizar mas não mostrar na página do curso\'. Neste caso, um link para a atividade ou recurso deve ser fornecido de outro lugar, como de um recurso de página. A atividade ainda será listada no quadro de notas e outros relatórios.';
$string['modvisiblewithstealth'] = 'Disponibilidade';
$string['modvisiblewithstealth_help'] = 'Se a disponibilidade estiver definida como \'Mostrar na página do curso\', a atividade ou recurso está disponível para estudantes (sujeito a restrições de acesso que podem ser definidas).<br><br>
Se a disponibilidade estiver definida como \'Ocultar dos estudantes\', a atividade ou recurso só estará disponível para usuários com permissão para visualizar atividades ocultas (por padrão, usuários com a função de professor ou professor não editor).<br><br>
Se o curso tiver muitas atividades ou recursos, a página do curso pode ser simplificada, definindo a disponibilidade para \'Disponibilizar mas não mostrar na página do curso\'. Neste caso, um link para a atividade ou recurso deve ser fornecido de outro lugar, como de um recurso de página. A atividade ainda será listada no quadro de notas e outros relatórios.';
$string['month'] = 'Mês';
$string['months'] = 'Meses';
...
$string['newpicture_help'] = 'Para adicionar uma nova imagem, navegue e seleciona uma imagem (em formato JPG ou PNG) então clique em "Atualizar perfil". A imagem será cortada como um quadrado e redimensionada para 100x100 pixels.';
...
$string['sectionusedefaultname'] = 'Utilizar o nome de seção padrão';
...
$string['sitemessage'] = 'Enviar mensagem aos usuários';
...
$string['switchrolereturn'] = 'Retomar ao meu papel normal';
