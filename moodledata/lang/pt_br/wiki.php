...
/**
 * Strings for component 'wiki', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   wiki
...
$string['firstpagetitle_help'] = 'Título da primeira página da wiki.';
...
$string['invalidsesskey'] = 'A sesskey fornecida não é válida. Por favor re-envie os dados novamente';
...
$string['modulename_help'] = 'O módulo de atividade wiki permite aos participantes adicionar e editar uma coleção de páginas da web. Um wiki pode ser colaborativo, com todos capazes de editá-lo, ou individual, onde todos têm seu próprio wiki que só eles podem editar.
...
* Para anotações de aula em grupo ou guias de estudo
* Para os membros de uma faculdade para planejar um esquema de trabalho ou reunião agenda juntos
* Para que os estudantes escrevam colaborativamente um livro online, criando conteúdo em um tópico definido pelo seu tutor
...
$string['pageexists'] = 'Esta página já existe. Redirecionado para ela.';
$string['pageindex'] = 'Índice das páginas';
$string['pageindex_help'] = 'àrvore de páginas da Wiki';
...
$string['page-mod-wiki-view'] = 'Módulo Wiki página principal';
...
$string['removeallwikitags'] = 'Remover todas as tags wiki';
...
$string['wiki:editpage'] = 'Salvar páginas wiki';
...
$string['wikiintro'] = 'Descrição da wiki';
