...
/**
 * Strings for component 'lesson', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   lesson
...
$string['dependencyon_help'] = '<p>Este parâmetro possibilita que esta lição dependa do desempenho do estudante em outra
...
$string['displayleftif_help'] = 'Esta configuração determina se um estudante deve obter uma certa nota antes de visualizar o menu da lição. Isso força o estudante a percorrer toda a lição na sua primeira tentativa e, depois de obter a nota exigida, ele pode usar o menu à esquerda para a revisão.';
...
$string['gradeessay'] = 'Perguntas de ensaio de classificação ({$a->notgradedcount} não classificado e {$a->notsentcount} não enviado)';
...
$string['jumps_help'] = 'Cada resposta (para questões) ou descrição (para páginas de conteúdo) tem um salto correspondente. O salto pode ser relativo, como esta página ou próxima página, ou absoluto, especificando qualquer uma das páginas da lição.';
...
$string['minimumnumberofquestions_help'] = 'Esta configuração especifica o número mínimo de questões que serão usadas para calcular uma nota para a atividade.';
