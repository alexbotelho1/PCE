...
/**
 * Strings for component 'block_rss_client', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['rss_client:myaddinstance'] = 'Adicionar um novo bloco remoto RSS feeds ao Painel';
