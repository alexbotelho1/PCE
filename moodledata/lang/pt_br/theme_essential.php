...
/**
 * Strings for component 'theme_essential', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['analyticscleanurl'] = 'URLs limpas';
$string['analyticscleanurldesc'] = 'Crie URL limpa para o rastreamento avançado';
$string['analyticsdesc'] = 'Escolha o tipo de serviço de análise de dados que você quer inserir e salve para habilitar outras opções.';
$string['analyticsenabled'] = 'Ativado';
$string['analyticsenableddesc'] = 'Ativar o Google Analytics para o Moodle';
...
$string['analyticsimagetrack'] = 'Rastreamento de imagens';
$string['analyticsimagetrackdesc'] = 'Ativar o Rastreamento de Imagens para navegadores com o JavaScript desabilitado.';
$string['analyticspiwik'] = 'Piwik';
$string['analyticssiteid'] = 'ID do site';
$string['analyticssiteiddesc'] = 'Forneça o ID do site';
$string['analyticssiteurl'] = 'URL do Analytics';
$string['analyticssiteurldesc'] = 'Digite o seu URL "Piwik Analytics" sem http (s) ou uma barra final. Por exemplo, "mysite.com/analytics".';
$string['analyticstrackadmin'] = 'Rastrear administradores';
$string['analyticstrackadmindesc'] = 'Ativar o rastreamento de usuários administradores (não recomendado)';
$string['analyticstrackingid'] = 'ID do site';
$string['analyticstrackingiddesc'] = 'Digite seu ID de rastreamento';
...
$string['hideontablet'] = 'Oculta o slide show em tablets';
...
$string['mobileappsheadingsub'] = 'Link para o seu aplicativo para que seus alunos que usam dispositivos móveis possam baixar';
...
$string['slidenodesc'] = 'Forneça as configurações para o slide {$a->slide}';
...
$string['slideshowheading'] = 'Página inicial do Slidehow';
