...
/**
 * Strings for component 'simplecertificate', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['eventcertificate_verified_description'] = 'O usuário com o ID {$a->userid} verifique o certificado com o ID {$a->certificateid}, emitido ao usuário com o ID {$a->certiticate_userid}.';
...
$string['notreceived'] = 'Nenhum certificado emitido.';
