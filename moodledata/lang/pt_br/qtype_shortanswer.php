...
/**
 * Strings for component 'qtype_shortanswer', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['pluginnameediting'] = 'Editando una pergunta de Resposta curta';
$string['pluginname_help'] = 'Em resposta a uma questão (que pode incluir uma imagem), respondente digita uma palavra ou frase curta. Podem haver várias respostas corretas, cada uma com uma avaliação diferente. Se a opção "case sensitive" for selecionada, então você pode ter resultados diferentes para "Palavra" ou "palavra ".';
