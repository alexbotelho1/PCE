...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   admin
...
$string['additionalhtmltopofbody'] = 'Quando a tag BODY é aberta';
...
$string['allowframembedding_help'] = 'Se ativado, este site pode ser incorporado em um frame em um sistema remoto, como recomendado ao usar o "Publicar como ferramenta de LTI \'plugin de inscrição. Caso contrário, recomenda-se a deixar moldura de incorporação desativada por motivos de segurança.';
...
$string['cfgwwwrootslashwarning'] = 'Você definiu $CFG->wwwroot incorretamente no seu arquivo config.php. Você incluiu um caractere \'/\' no final. Por favor remova-o, ou ocorrerão erros estranhos como <a href=\'http://tracker.moodle.org/browse/MDL-11061\'>MDL-11061</a>.';
...
$string['cliupgradefinished'] = 'Atualização via linha de comando completada com sucesso.';
...
$string['commonactivitysettings'] = 'Configurações de atividade comum';
...
$string['configcustommenuitems'] = 'Você pode configurar um menu personalizado aqui para ser mostrado por temas. Cada linha consiste em algum texto de menu, um URL de link (opcional), um título de tooltip (opcional) e um código de idioma ou lista de códigos separados por vírgulas (opcional, para exibir a linha somente para usuários do idioma especificado) separados por Pipe caracteres. Linhas começando com um hífen aparecerão como itens de menu no menu de nível superior anterior e divisores podem ser usados adicionando uma linha de um ou mais caracteres # quando desejado. Por exemplo:
<pre>
Comunidade Moodle|https://moodle.org
-Suporte Moodle gratuito|https://moodle.org/support
-###
...
$string['configenableactivitychooser'] = 'O seletor de atividade é uma caixa de diálogo com uma breve descrição de cada atividade e recurso. Se desabilitado, menus separados de recurso e atividade são fornecidos em vez disso.';
...
Você pode comprar uma versão comercial ou usar a versão livre.<br /> É só baixar <a href="http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz" >http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz</a> e extrair no diretório "{$a}" do seu servidor.';
...
$string['configrecaptchaprivatekey'] = 'Cadeia de caracteres usada para comunicação entre o servidor do seu Moodle e o servidor recaptcha.net. Obtenha uma para este site visitando <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
$string['configrecaptchapublickey'] = 'Cadeia de caracteres (chave pública) usado para exibir o elemento de reCAPTCHA no formulário de inscrição. chaves reCAPTCHA pode ser obtido a partir de <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['enableglobalsearch_desc'] = 'Se ativado, os dados serão indexados e sincronizados por uma tarefa agendada.';
...
$string['fileconversioncleanuptask'] = 'Limpeza de registros temporários para conversões de arquivos.';
...
$string['iplookupmaxmindnote'] = 'Esse produto inclue dados GeoLite2 criados por MaxMind, disponível em <a href="http://www.maxmind.com/">http://www.maxmind.com/</a>.';
...
$string['navsortmycoursessort_help'] = 'Isso determina se os cursos serão listados em Meus cursos de acordo com a ordem de classificação (ou seja, a ordem definida em Configurações > Administração do Site > Gerenciar os cursos e categorias) ou em ordem alfabética pelo ambiente do curso.';
$string['never'] = 'Nunca';
...
$string['pathtodot_help'] = 'Caminho para o dot. Provavelmente algo como /usr/bin/dot. Para ser possível gerar gráficos de arquivos DOT, você deve ter instalado o executável dot e apontá-lo aqui. Note que, por enquanto, isto só é usado pelos recursos de "profiling" (Desenvolvimento->Profiling) do Moodle. Em algums distribuições Linux, este aplicativo é fornecido pelo pacote graphviz .';
...
$string['registration_help'] = 'É recomendável que você registrar seu site para receber alertas de segurança e acesso a Moodle.net, a nossa plataforma de compartilhamento de curso.';
...
$string['selectsearchengine'] = 'Escolha um motor de busca';
...
$string['setupsearchengine'] = 'Configuração do motor de busca';
