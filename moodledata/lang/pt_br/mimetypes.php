...
/**
 * Strings for component 'mimetypes', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   mimetypes
...
$string['application/vnd.openxmlformats-officedocument.presentationml.presentation'] = 'Apresentação Powerpoint';
$string['application/vnd.openxmlformats-officedocument.presentationml.slideshow'] = 'Slideshow do Powerpoint';
$string['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'] = 'Planilha do Excel';
$string['application/vnd.openxmlformats-officedocument.spreadsheetml.template'] = 'Template do Excel';
$string['application/vnd.openxmlformats-officedocument.wordprocessingml.document'] = 'Documento do Word';
