...
/**
 * Strings for component 'survey', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   survey
...
$string['allquestionrequireanswer'] = 'Todas as questões são obrigatórias e devem ser respondidas.';
...
$string['cannotfindanswer'] = 'Não há respostas para esta pesquisa ainda.';
$string['cannotfindquestion'] = 'Questão não existe';
$string['cannotfindsurveytmpt'] = 'Nenhum modelos de pesquisa encontrado!';
...
$string['colles10'] = 'Peço aos outros estudantes explicações sobre as idéias deles.';
...
$string['colles18short'] = 'estudantes me elogiam';
$string['colles19'] = 'Os outros participantes estimam as minhas contribuições.';
$string['colles19short'] = 'estudantes me estimam';
...
$string['completionsubmit'] = 'O estudante tem de submeter esta atividade para concluí-la';
...
$string['invalidsurveyid'] = 'ID de pesquisa estava incorreto';
$string['invalidtmptid'] = 'Id de modelo inválido';
$string['ipreferthat'] = 'Freqüência desejada';
$string['modulename'] = 'Pesquisa de avaliação';
$string['modulename_help'] = 'O módulo de atividade pesquisa fornece uma série de instrumentos de inquérito validados que têm sido úteis para aferir e estimular a aprendizagem em ambientes on-line. Um professor pode usá-los para recolher dados dos seus estudantes que irão ajudá-los a aprender a sua turma e reflectir sobre o seu próprio ensino. Note que estas ferramentas de pesquisa são pré-preenchida com perguntas. Os professores que desejam criar o seu próprio inquérito deve usar o módulo atividade feedback.';
...
$string['notyetanswered'] = 'Ainda não respondeu';
$string['othercomments'] = 'Você quer fazer outros comentários?';
$string['page-mod-survey-x'] = 'Qualquer página do módulo pesquisa';
$string['peoplecompleted'] = '{$a} pessoas já responderam ao questionário';
$string['pluginadministration'] = 'Administração de pesquisa';
$string['pluginname'] = 'Pesquisa de avaliação';
...
$string['responsereports'] = 'Relatório de resposta';
...
$string['survey:addinstance'] = 'Adicionar nova pesquisa';
...
$string['surveycompletednograph'] = 'Você completou essa pesquisa.';
$string['survey:download'] = 'Baixar respostas';
$string['surveygraph'] = 'Gráfico da pesquisa';
$string['surveyname'] = 'Nome da pesquisa de avaliação';
$string['survey:participate'] = 'Responder ao questionário';
...
$string['surveytype_help'] = 'Existem 3 tipos de pesquisa disponíveis: Atitudes * para Pensar e Aprender Survey (ATTLS) - para medir o grau em que uma pessoa é um "conhecedor conectado \'(tende a encontrar o aprendizado mais agradável, e é geralmente mais cooperativos, afáveis e mais dispostos construir sobre as idéias dos outros) ou um saber \'destacado\' (tende a assumir uma postura mais crítica e criar polêmicas) * levantamento dos incidentes críticos * construtivista On-line Pesquisa Ambiente de Aprendizagem (COLLES) - Para monitorar a medida em que o capacidade interativa da World Wide Web pode ser explorada para envolver os estudantes em dinâmicas práticas de aprendizagem';
