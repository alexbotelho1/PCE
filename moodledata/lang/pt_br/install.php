...
/**
 * Strings for component 'install', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   install
...
<p>Os campos nome do banco de dados, usuário e senha , são necessários; o prefixo da tabela é opcional. </p>
<p>O nome da base de dados deve conter apenas caracteres alfa-numéricos, dóla ($) e sublinahdo (_).</p>
