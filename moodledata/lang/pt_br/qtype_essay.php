...
/**
 * Strings for component 'qtype_essay', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   qtype_essay
...
$string['formatnoinline'] = 'Nenhum texto "inline"';
$string['formatplain'] = 'Texto simples';
$string['graderinfo'] = 'Informação para avaliadores';
$string['graderinfoheader'] = 'Selecionador de informações';
$string['mustattach'] = 'Quando "nenhum texto inline" é selecionado ou as respostas são opcionais, você deve permitir pelo menos um anexo.';
$string['mustrequire'] = 'Quando "não há texto em linha" é selecionado ou as respostas são opcionais, você deve exigir pelo menos um anexo.';
...
$string['pluginnameediting'] = 'Editando uma pergunta de Ensaio';
...
$string['pluginnamesummary'] = 'Permite uma resposta com algumas frases ou parágrafos. Deve, então, ser avaliada manualmente.';
