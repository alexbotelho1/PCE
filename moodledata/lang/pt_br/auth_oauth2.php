...
/**
 * Strings for component 'auth_oauth2', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   auth_oauth2
...
Para confirmar sua nova conta, acesse o endereço da Internet:
...
$string['emailconfirmlinksent'] = '<p> Já existe uma conta com este endereço de e-mail, mas ainda não está vinculada. </p>
<p> As contas devem estar vinculadas antes de iniciar sessão. </p>
<p> Um e-mail deve ter sido enviado para o seu endereço em <b> {$a} </b>. </p>
<p> O e-mail contém instruções fáceis para vincular suas contas. </p> <p> Se você tiver alguma dificuldade, entre em contato com o administrador do site.
</p>';
