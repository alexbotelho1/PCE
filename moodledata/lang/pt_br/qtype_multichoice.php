...
/**
 * Strings for component 'qtype_multichoice', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['answernumbering'] = 'Numerar as escolhas?';
...
$string['errfractionsnomax'] = 'Uma das escolhas deve ser 100% para que seja<br /> possível conseguir uma nota máxima nessa questão.';
...
$string['notenoughanswers'] = 'Este tipo de questão requer pelo menos {$a} escolhas';
...
$string['pluginname_help'] = 'Em resposta a uma questão (que pode incluir uma imagem), o entrevistado escolhe respostas múltiplas. Existem dois tipos de questões de múltipla escolha - uma resposta e múltiplas respostas.';
$string['pluginname_link'] = 'question/type/multichoice';
$string['pluginnamesummary'] = 'Permite a seleção de simples ou múltiplas respostas de uma lista pré definida.';
$string['selectmulti'] = 'Escolha uma ou mais:';
$string['selectone'] = 'Escolha uma:';
$string['shuffleanswers'] = 'Misturar as opções?';
$string['shuffleanswers_help'] = 'Se ativado, a ordem das respostas será misturada aleatoriamente para cada tentativa, contanto que \'Misturar entre as questões\' também esteja habiçitado na configuração do questionário.';
$string['singleanswer'] = 'Escolha uma resposta.';
$string['toomanyselected'] = 'Você selecionou alternativas demais.';
