...
/**
 * Strings for component 'tool_spamcleaner', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['spamfromblog'] = 'Da mensagem do blog:';
$string['spamfromcomments'] = 'De comentários:';
$string['spamfromforumpost'] = 'De mensagens do fórum:';
$string['spamfrommessages'] = 'De mensagens:';
$string['spaminvalidresult'] = 'Resultado desconhecido e não válido';
$string['spamkeyword'] = 'Palavra-chave';
$string['spamoperation'] = 'Operação';
$string['spamresult'] = 'Resultado da busca de usuários que contém:';
$string['spamsearch'] = 'Buscar estas palavras';
