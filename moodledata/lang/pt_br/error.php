...
/**
 * Strings for component 'error', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   error
...
$string['activityisscheduledfordeletion'] = 'A atividade está sendo apagada...';
...
$string['cannotedituserpreferences'] = 'Não é possível editar as preferências deste usuário';
...
$string['cannotreprocessgrades'] = 'Não foi possível reprocessar notas para esta atividade {$a}';
...
$string['cannotupdateusermsgpref'] = 'Não é possível atualizar as preferências de mensagens de usuário';
...
$string['confirmationnotenabled'] = 'A confirmação do usuário não está ativada neste site';
...
$string['enddatebeforestartdate'] = 'A data de término do curso deve ser posterior a data de início.';
...
$string['erroroutput'] = 'Erro de saída, desabilitar redirecionamento automático.';
...
$string['invalidcourseformat'] = 'Formato do curso inválido';
...
$string['invalidsesskey'] = 'Sua sessão provavelmente expirou. Por favor faça login novamente.';
...
$string['invaliduserdata'] = 'Dados inválidos do usuário: {$a}';
...
$string['maxbytesfile'] = 'O arquivo {$a->file} é muito grande. Apenas pode carregar arquivos com um tamanho máximo de {$a->size}.';
...
$string['mnetlocal'] = 'Usuários do MNET Remoto não podem fazer login localmente';
...
$string['nologinas'] = 'Você não tem permissão para fazer login como esse usuário';
...
$string['nostartdatenoenddate'] = 'A data de término do curso só pode ser definida se a data de início também estiver habilitada.';
...
$string['storedfilecannotread'] = 'Não é possível ler o arquivo. Ou o arquivo não existe ou há um problema de permissão.';
...
$string['unicodeupgradeerror'] = 'Desculpe, mas seu banco de dados não está em Unicode, e esta versão do Moodle não é capaz de migrar seu banco de dados para o Unicode. Atualize para o Moodle 1.7.x primeiro e execute a migração Unicode da página Admin. Depois disso, você deve poder migrar para o Moodle {$a}';
...
$string['usernotdeleteddeleted'] = 'Este usuário já foi excluído.';
...
$string['usernotfullysetup'] = 'O usuário não está totalmente configurado';
