...
/**
 * Strings for component 'calendar', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
 * @package   calendar
...
$string['errorinvalidbydayprefix'] = 'Valores inteiros que precedem as regras Por dia só podem estar presentes para MENSAIS ou ANUALMENTE unicamente.';
...
$string['errorrrule'] = 'A regra aprovada parece incorreta';
$string['errorrruleday'] = 'A regra tem um parâmetro de dia inválido';
$string['errorrrulefreq'] = 'A regra tem um parâmetro de frequência inválido';
...
$string['eventsrelatedtocourses'] = 'Eventos relativos aos cursos';
...
$string['eventsupdated'] = 'Eventos atualização: {$a}';
...
$string['hideuserevents'] = 'Ocultar eventos de usuário';
$string['hourly'] = 'De hora em hora';
$string['ical'] = 'iCal';
$string['importcalendar'] = 'Importar calendário';
$string['importcalendarfrom'] = 'Importar de';
$string['importcalendarheading'] = 'Importa calendário...';
$string['importfromfile'] = 'Arquivo de calendário (.ics)';
$string['importfrominstructions'] = 'Por favor, forneça um URL a um calendário remoto, ou faça upload de um arquivo.';
$string['importfromurl'] = 'URL do calendário';
$string['invalidtimedurationminutes'] = 'A duração em minutos inserida é inválida. Por favor, insira uma duração em minutos maior que zero ou selecione sem duração.';
$string['invalidtimedurationuntil'] = 'A data e hora selecionados para duração é anterior ao início do evento. Por favor corrija isto antes de prosseguir.';
...
$string['pollinterval_help'] = 'Quantas vezes você gostaria que o calendário para atualizar com novos eventos.';
...
$string['quickdownloadcalendar'] = 'Download veloz / subscrição ao calendário';
...
$string['showcourseevents'] = 'Exibir eventos de curso';
$string['showglobalevents'] = 'Exibir eventos globais';
$string['showgroupsevents'] = 'Exibir eventos de grupo';
$string['shown'] = 'visualizados';
$string['showuserevents'] = 'Exibir eventos de usuário';
...
$string['urlforical'] = 'URL para exportação iCalendar, para subscrição ao calendário';
$string['user'] = 'Usuário';
