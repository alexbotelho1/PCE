...
/**
 * Strings for component 'theme_adaptable', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['blocklayoutbuilder'] = 'Região de cada bloco na página principal';
$string['blocklayoutlayoutcheck'] = 'Verifique seu layout';
$string['blocklinkcolor'] = 'Cor do link dentro de um bloco';
$string['blocklinkcolordesc'] = 'Selecione a cor dos links dentro de um bloco';
