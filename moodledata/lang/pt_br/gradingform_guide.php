...
/**
 * Strings for component 'gradingform_guide', language 'pt_br', branch 'MOODLE_33_STABLE'
 *
...
$string['hidestudentdesc'] = 'Esconder as descrições dos critérios do estudante';
$string['insertcomment'] = 'Inserir comentário utilizado com frequência';
$string['maxscore'] = 'Nota máxima';
$string['name'] = 'Nome';
$string['needregrademessage'] = 'As definições do guia de avaliação foram alteradas depois que o estudante ser avaliado. O estudante não pode ver seu guia de avaliação até que ela seja verificada e a nota atualizada.';
